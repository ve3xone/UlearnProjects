#  Ulearn (Основы программирования на примере C#. Часть 2) Второй семестр
...
- [Практика «Игра»](https://github.com/ve3xone/BloodyPath) (Сделал на monogame, 2d fighter, получил 6 баллов из 10 баллов)
